...
@SpringBootTest
class AgenceVoitureVersion31ApplicationTests {
	...
	@Test
	 ...
	 {
		 List<Voiture> voits = voitureRepository.findByModeleVoiturePrixVoiture("GOLF7",7777D);
		 for (Voiture v : voits)
		 {
		 System.out.println(v.getModeleVoiture());
		 }
	 ...
	 @Test
	 public void findByOrderByModeleVoitureAsc()
	 {
		 List<Voiture> voits =
	 ...
	 @Test
	 public void trierVoituresModelesPrix()
		 {
